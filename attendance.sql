...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2019 at 12:06 PM
...
(3, 'admin', 'sahun5774@gmail.com', 'a152e841783914146e4bcd4f39100686'),
(4, 'globy', 'sahte@gmail.com', '5eb63bbbe01eeed093cb22bb8f5acdc3');
...
--
ALTER TABLE `users`
  MODIFY `usrid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
